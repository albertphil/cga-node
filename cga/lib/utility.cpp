...
{
	/*
	 * cga::thread_role namespace
	 *
	 * Manage thread role
	 */
	static thread_local cga::thread_role::name current_thread_role = cga::thread_role::name::unknown;
	cga::thread_role::name get ()
	{
		return current_thread_role;
	}

	static std::string get_string (cga::thread_role::name role)
	{
		std::string thread_role_name_string;

		switch (role)
		{
			case cga::thread_role::name::unknown:
				thread_role_name_string = "<unknown>";
				break;
			case cga::thread_role::name::io:
				thread_role_name_string = "I/O";
				break;
			case cga::thread_role::name::work:
				thread_role_name_string = "Work pool";
				break;
			case cga::thread_role::name::packet_processing:
				thread_role_name_string = "Pkt processing";
				break;
			case cga::thread_role::name::alarm:
				thread_role_name_string = "Alarm";
				break;
			case cga::thread_role::name::vote_processing:
				thread_role_name_string = "Vote processing";
				break;
			case cga::thread_role::name::block_processing:
				thread_role_name_string = "Blck processing";
				break;
			case cga::thread_role::name::request_loop:
				thread_role_name_string = "Request loop";
				break;
			case cga::thread_role::name::wallet_actions:
				thread_role_name_string = "Wallet actions";
				break;
			case cga::thread_role::name::bootstrap_initiator:
				thread_role_name_string = "Bootstrap init";
				break;
			case cga::thread_role::name::voting:
				thread_role_name_string = "Voting";
				break;
			case cga::thread_role::name::signature_checking:
				thread_role_name_string = "Signature check";
				break;
			case cga::thread_role::name::slow_db_upgrade:
	...
	void set (cga::thread_role::name role)
	{
		auto thread_role_name_string (get_string (role));

		cga::thread_role::set_os_name (thread_role_name_string);

		cga::thread_role::current_thread_role = role;
	}
}
}

void cga::thread_attributes::set (boost::thread::attributes & attrs)
{
	auto attrs_l (&attrs);
