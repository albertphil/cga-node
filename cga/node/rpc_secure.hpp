...
{
/**
 * Specialization of cga::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_service & service_a, cga::node & node_a, cga::rpc_config const & config_a);
...
/**
 * Specialization of cga::rpc_connection for establishing TLS connections.
 * Handshakes with client certificates are supported.
 */
class rpc_connection_secure : public rpc_connection
{
public:
	rpc_connection_secure (cga::node &, cga::rpc_secure &);
