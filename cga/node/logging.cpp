...
void cga::logging::init (boost::filesystem::path const & application_path_a)
{
...
cga::error cga::logging::serialize_json (cga::jsonconfig & json) const
{
...
bool cga::logging::upgrade_json (unsigned version_a, cga::jsonconfig & json)
{
	json.put ("version", json_version ());
...
cga::error cga::logging::deserialize_json (bool & upgraded_a, cga::jsonconfig & json)
{
	int version_l;
...
bool cga::logging::ledger_logging () const
{
	return ledger_logging_value;
}

bool cga::logging::ledger_duplicate_logging () const
{
	return ledger_logging () && ledger_duplicate_logging_value;
}

bool cga::logging::vote_logging () const
{
	return vote_logging_value;
}

bool cga::logging::network_logging () const
{
	return network_logging_value;
}

bool cga::logging::network_message_logging () const
{
	return network_logging () && network_message_logging_value;
}

bool cga::logging::network_publish_logging () const
{
	return network_logging () && network_publish_logging_value;
}

bool cga::logging::network_packet_logging () const
{
	return network_logging () && network_packet_logging_value;
}

bool cga::logging::network_keepalive_logging () const
{
	return network_logging () && network_keepalive_logging_value;
}

bool cga::logging::network_node_id_handshake_logging () const
{
	return network_logging () && network_node_id_handshake_logging_value;
}

bool cga::logging::node_lifetime_tracing () const
{
	return node_lifetime_tracing_value;
}

bool cga::logging::insufficient_work_logging () const
{
	return network_logging () && insufficient_work_logging_value;
}

bool cga::logging::log_rpc () const
{
	return network_logging () && log_rpc_value;
}

bool cga::logging::log_ipc () const
{
	return network_logging () && log_ipc_value;
}

bool cga::logging::bulk_pull_logging () const
{
	return network_logging () && bulk_pull_logging_value;
}

bool cga::logging::callback_logging () const
{
	return network_logging ();
}

bool cga::logging::work_generation_time () const
{
	return work_generation_time_value;
}

bool cga::logging::upnp_details_logging () const
{
	return upnp_details_logging_value;
}

bool cga::logging::timing_logging () const
{
	return timing_logging_value;
}

bool cga::logging::log_to_cerr () const
{
