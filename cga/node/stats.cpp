...
cga::error cga::stat_config::deserialize_json (cga::jsonconfig & json)
{
...
std::string cga::stat_log_sink::tm_to_string (tm & tm)
{
...
class json_writer : public cga::stat_log_sink
{
...
class file_writer : public cga::stat_log_sink
{
public:
	std::ofstream log;
	std::string filename;
...
cga::stat::stat (cga::stat_config config) :
config (config)
{
}

std::shared_ptr<cga::stat_entry> cga::stat::get_entry (uint32_t key)
{
	return get_entry (key, config.interval, config.capacity);
}

std::shared_ptr<cga::stat_entry> cga::stat::get_entry (uint32_t key, size_t interval, size_t capacity)
{
	std::unique_lock<std::mutex> lock (stat_mutex);
	return get_entry_impl (key, interval, capacity);
}

std::shared_ptr<cga::stat_entry> cga::stat::get_entry_impl (uint32_t key, size_t interval, size_t capacity)
{
	std::shared_ptr<cga::stat_entry> res;
	auto entry = entries.find (key);
	if (entry == entries.end ())
	{
		res = entries.insert (std::make_pair (key, std::make_shared<cga::stat_entry> (capacity, interval))).first->second;
	}
	else
	{
		res = entry->second;
...
std::unique_ptr<cga::stat_log_sink> cga::stat::log_sink_json ()
{
	return std::make_unique<json_writer> ();
}

std::unique_ptr<cga::stat_log_sink> log_sink_file (std::string filename)
{
	return std::make_unique<file_writer> (filename);
}

void cga::stat::log_counters (stat_log_sink & sink)
{
	std::unique_lock<std::mutex> lock (stat_mutex);
	log_counters_impl (sink);
}

void cga::stat::log_counters_impl (stat_log_sink & sink)
{
	sink.begin ();
...
void cga::stat::log_samples (stat_log_sink & sink)
{
	std::unique_lock<std::mutex> lock (stat_mutex);
	log_samples_impl (sink);
}

void cga::stat::log_samples_impl (stat_log_sink & sink)
{
	sink.begin ();
	if (sink.entries () >= config.log_rotation_count)
	{
...
void cga::stat::update (uint32_t key_a, uint64_t value)
{
...
std::chrono::seconds cga::stat::last_reset ()
{
	std::unique_lock<std::mutex> lock (stat_mutex);
	auto now (std::chrono::steady_clock::now ());
...
std::string cga::stat::type_to_string (uint32_t key)
{
	auto type = static_cast<stat::type> (key >> 16 & 0x000000ff);
	std::string res;
	switch (type)
	{
		case cga::stat::type::ipc:
			res = "ipc";
			break;
		case cga::stat::type::block:
			res = "block";
			break;
		case cga::stat::type::bootstrap:
			res = "bootstrap";
			break;
		case cga::stat::type::error:
			res = "error";
			break;
		case cga::stat::type::http_callback:
			res = "http_callback";
			break;
		case cga::stat::type::ledger:
			res = "ledger";
			break;
		case cga::stat::type::udp:
			res = "udp";
			break;
		case cga::stat::type::peering:
			res = "peering";
			break;
		case cga::stat::type::rollback:
			res = "rollback";
			break;
		case cga::stat::type::traffic:
			res = "traffic";
			break;
		case cga::stat::type::traffic_bootstrap:
			res = "traffic_bootstrap";
			break;
		case cga::stat::type::vote:
			res = "vote";
			break;
		case cga::stat::type::message:
			res = "message";
			break;
	}
	return res;
...
std::string cga::stat::detail_to_string (uint32_t key)
{
	auto detail = static_cast<stat::detail> (key >> 8 & 0x000000ff);
	std::string res;
	switch (detail)
	{
		case cga::stat::detail::all:
			res = "all";
			break;
		case cga::stat::detail::bad_sender:
			res = "bad_sender";
			break;
		case cga::stat::detail::bulk_pull:
			res = "bulk_pull";
			break;
		case cga::stat::detail::bulk_pull_account:
			res = "bulk_pull_account";
			break;
		case cga::stat::detail::bulk_push:
			res = "bulk_push";
			break;
		case cga::stat::detail::change:
			res = "change";
			break;
		case cga::stat::detail::confirm_ack:
			res = "confirm_ack";
			break;
		case cga::stat::detail::node_id_handshake:
			res = "node_id_handshake";
			break;
		case cga::stat::detail::confirm_req:
			res = "confirm_req";
			break;
		case cga::stat::detail::fork:
			res = "fork";
			break;
		case cga::stat::detail::frontier_req:
			res = "frontier_req";
			break;
		case cga::stat::detail::handshake:
			res = "handshake";
			break;
		case cga::stat::detail::http_callback:
			res = "http_callback";
			break;
		case cga::stat::detail::initiate:
			res = "initiate";
			break;
		case cga::stat::detail::initiate_lazy:
			res = "initiate_lazy";
			break;
		case cga::stat::detail::initiate_wallet_lazy:
			res = "initiate_wallet_lazy";
			break;
		case cga::stat::detail::insufficient_work:
			res = "insufficient_work";
			break;
		case cga::stat::detail::invocations:
			res = "invocations";
			break;
		case cga::stat::detail::keepalive:
			res = "keepalive";
			break;
		case cga::stat::detail::open:
			res = "open";
			break;
		case cga::stat::detail::publish:
			res = "publish";
			break;
		case cga::stat::detail::receive:
			res = "receive";
			break;
		case cga::stat::detail::republish_vote:
			res = "republish_vote";
			break;
		case cga::stat::detail::send:
			res = "send";
			break;
		case cga::stat::detail::state_block:
			res = "state_block";
			break;
		case cga::stat::detail::epoch_block:
			res = "epoch_block";
			break;
		case cga::stat::detail::vote_valid:
			res = "vote_valid";
			break;
		case cga::stat::detail::vote_replay:
			res = "vote_replay";
			break;
		case cga::stat::detail::vote_invalid:
			res = "vote_invalid";
			break;
		case cga::stat::detail::vote_overflow:
			res = "vote_overflow";
			break;
		case cga::stat::detail::blocking:
			res = "blocking";
			break;
		case cga::stat::detail::overflow:
			res = "overflow";
			break;
		case cga::stat::detail::unreachable_host:
			res = "unreachable_host";
			break;
		case cga::stat::detail::invalid_magic:
			res = "invalid_magic";
			break;
		case cga::stat::detail::invalid_network:
			res = "invalid_network";
			break;
		case cga::stat::detail::invalid_header:
			res = "invalid_header";
			break;
		case cga::stat::detail::invalid_message_type:
			res = "invalid_message_type";
			break;
		case cga::stat::detail::invalid_keepalive_message:
			res = "invalid_keepalive_message";
			break;
		case cga::stat::detail::invalid_publish_message:
			res = "invalid_publish_message";
			break;
		case cga::stat::detail::invalid_confirm_req_message:
			res = "invalid_confirm_req_message";
			break;
		case cga::stat::detail::invalid_confirm_ack_message:
			res = "invalid_confirm_ack_message";
			break;
		case cga::stat::detail::invalid_node_id_handshake_message:
			res = "invalid_node_id_handshake_message";
			break;
		case cga::stat::detail::outdated_version:
...
std::string cga::stat::dir_to_string (uint32_t key)
{
	auto dir = static_cast<stat::dir> (key & 0x000000ff);
	std::string res;
	switch (dir)
	{
		case cga::stat::dir::in:
			res = "in";
			break;
		case cga::stat::dir::out:
			res = "out";
			break;
	}
	return res;
